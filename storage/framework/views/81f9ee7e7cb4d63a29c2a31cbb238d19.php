...
<section class="register create">
    <form action="<?php echo e(url('users/'.$user->id)); ?>" method="post" enctype="multipart/form-data">
        ...
        <img src="<?php echo e(asset('images/'.$user->photo)); ?>" id="upload" width="240px" alt="Upload">
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\EL_DOGY(2)\04-Laravel\larapp\resources\views/users/edit.blade.php ENDPATH**/ ?>