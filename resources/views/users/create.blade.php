@extends('layouts.app')
@section('title', 'reate User Page - PetsApp')
...
<form action="{{route('users.store')}}" method="post" enctype="multipart/form-data">
    @csrf
    <img src="{{asset('images/ico-upload-user.svg')}}" id="upload" alt="Slide">
    ...
    <select name="gender" >
        ...
        <option value="Esclavo"  @if(old('gender')=='Esclavo') selected @endif> Esclavo</option>
    </select>
